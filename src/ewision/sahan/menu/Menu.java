...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"~Product~"},
        {"Product", "New Product", "Product List", "Print Barcode"},
        {"Adjustment", "New Adjustment", "Adjustment List"},
        {"Transfer", "New Transfer", "Transfer List"},
        {"~Transactions~"},
        {"Expenses", "New Expense", "Expense List", "Expense Category"},
        {"Quotation", "New Quotation", "Quatation List"},
        {"Purchases", "New Purchase", "Purchase List"},
        {"Sales", "New Sale", "Sales List"},
        {"Sale Returns", "New Sale Return", "Sale Returns List"},
        {"Purchase Returns", "New Purchase Return", "Purchase Returns List"},
        {"~Human Resourses~"},
        {"HRM", "Company", "Departments", "Designations", "Office Shift", "Employees", "Attendance", "Holidays", "Leaves"},
        {"People", "Customers", "Suppliers", "Users"},
        {"~OTHER~"},
        {"Reports", "Profit and Loss", "Product Quantity Alerts", "Warehouse Report", "Sale Report",
            "Purchase Report", "Customer Report", "Supplier Report", "Top Selling Products", "Best Customers", "User Report", "Payments"},
